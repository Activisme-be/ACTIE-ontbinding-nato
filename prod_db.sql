...
--
-- Host: localhost    Database: stop_nato
-- ------------------------------------------------------
...
CREATE TABLE `countries` (
  ...
  `country_code` varchar(65) DEFAULT NULL,
  `country_name` varchar(255) DEFAULT NULL,
  `country_flag` varchar(255) DEFAULT NULL,
  `fips_code` varchar(255) DEFAULT NULL,
  `iso_num` varchar(255) DEFAULT NULL,
  `north_num` varchar(255) DEFAULT NULL,
  `south_num` varchar(255) DEFAULT NULL,
  `west_num` varchar(255) DEFAULT NULL,
  `east_num` varchar(255) DEFAULT NULL,
  `capital_name` varchar(255) DEFAULT NULL,
  `languages` text,
  `isoAlpha3_num` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2017-05-23  0:01:40
