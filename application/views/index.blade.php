		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<ol class="list-unstyled" style="list-style: decimal inside;">
					<li style="padding-bottom: 5px;">vaststellend dat Operation Allied Force (24 maart – 10 juni) in Kosovo en Servië niet gedekt was door een mandaat van de Veiligheidsraad van de Verenigde Naties, noch dat het om een daad van zelfverdediging ging zoals verlangd door het VN-Handvest;</li>
					<li style="padding-bottom: 5px;">vaststellend dat de oorlog in Kosovo en Servië in overtreding is met artikel 1 van het NAVO-verdrag waarin de partijen er zich toe verbinden om “zich in hun internationale betrekkingen te onthouden van bedreiging met of gebruik van geweld op enige wijze die onverenigbaar is met de doelstelling van de Verenigde Naties";</li>
					<li style="padding-bottom: 5px;">vaststellend dat de militaire internationale operaties in voormalig Joegoslavië en Libië niet gedekt waren door het NAVO-verdrag dat krachtens artikel 5 het optreden van de alliantie beperkt tot de verdediging van het grondgebied;</li>
				...
				<ol class="list-unstyled" style="list-style: decimal inside;">
					...
					<li style="padding-bottom: 5px;">wegens inbreuken op het NAVO-verdrag, meer bepaald op de preambule, artikel 1, artikel 2, artikel 5 en artikel 6;</li>
					<li style="padding-bottom: 5px;">wegens inbreuken op het NPT-verdrag;</li>
